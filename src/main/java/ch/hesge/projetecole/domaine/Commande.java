 ...
 *
 * L'Article qui fait l'objet de la Commande est en lecture seule (une fois une
 * Commande instanciée, l'Article ne peut pas être modifié) La quantité peut
 * être ajustée selon la commande
 *
 * @author JSI
 * @version 1.1
 */
public class Commande implements Comparable {
    ...
    public void incQte(int qteSuplementaire) {
        this.qte += qteSuplementaire;
    }
